...
return new class extends Migration
{
    ...
    {
        Schema::create('pension_fund_payrolls', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('employee_id');
            $table->enum('pension', ['fixed_amount','percentage_of_rfi']);
    ...
    {
        Schema::dropIfExists('pension_fund_payrolls');
    }
};
