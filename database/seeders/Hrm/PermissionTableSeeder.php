...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        {
            $permissionModel = Permission::where('name', $value)->first();
            ...
            } elseif ($permissionModel->module !== 'Hrm') {
                $permissionModel->module = 'Hrm';
                $permissionModel->save();
            }

            if (!empty($company_role) && !$company_role->hasPermission($value)) {
