...
for (var l = 0; l < elem.length; l++) {
  ...
  var linkHref = elem[l].href;
  var linkPath = elem[l].getAttribute("href");
  // Match exact URL or treat current URL as a sub-path of the menu link
  var isActive = (linkHref == pageUrl) ||
    (linkPath && linkPath !== "" && linkPath !== "/" && linkPath.length > 1 && pageUrl.indexOf(linkHref) === 0);
