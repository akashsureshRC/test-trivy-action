...
<title>@yield('page-title') | {{ !empty($company_settings['title_text']) ? $company_settings['title_text'] : (!empty($admin_settings['title_text']) ? $admin_settings['title_text'] :'RC ClearPay') }}</title>
...
<meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
 ...
 <!-- Favicon icon -->
 <link rel="icon" href="{{ getLogoUrl($favicon, 'favicon') ?? getLogoFallback('favicon') }}{{'?'.time()}}" type="image/x-icon" />
