                    ...
                    <div class="">
                        ...
                        <div class="form-check ">
                            ...
                            <label class="form-check-label text-sm" for="termsCheckbox">
                                {{ __('I agree to the ') }}
                                <a href="https://rcclearpay.co.za/terms" target="_blank" rel="noopener">{{ __('Terms and Conditions') }}</a>
                                {{ __('and the ') }}
                                <a href="https://rcclearpay.co.za/privacy" target="_blank" rel="noopener">{{ __('Privacy Policy') }}</a>
                            </label>
                        </div>
                        ...
                        @endif
                        <div class="d-grid">
                            <button class="btn btn-rc-primary mt-2" type="submit">{{ __('Register') }}</button>
                            @stack('SigninButton')
                        </div>
