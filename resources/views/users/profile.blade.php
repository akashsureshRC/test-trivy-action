    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-xl-9">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        <img src="{{ getAvatarUrl($userDetail->avatar) }}" id="myAvatar" alt="user-image" class="rounded-circle img-thumbnail m-2" style="width:120px; height:120px">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('current_password', __('Current Password'), ['class' => 'form-label text-dark']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('new_password', __('New Password'), ['class' => 'form-label text-dark']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('confirm_password', __('New Confirm Password'), ['class' => 'form-label text-dark']) }}
                                        {{ Form::password('confirm_password', ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter Confirm Password')]) }}
                ...
                @stack('jobsearch_setting_sidebar_div')
            </div>
        </div>
    </div>
</div>
