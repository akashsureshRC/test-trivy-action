{{ Form::open(['route' => ['billing.tiers.update', $tier->id], 'method' => 'PUT']) }}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('name', $tier->name, ['class' => 'form-control', 'placeholder' => __('e.g., Starter, Growth, Enterprise'), 'required' => true]) }}
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <span class="text-danger">*</span>
                {{ Form::number('min_payslips', $tier->min_payslips, ['class' => 'form-control', 'min' => 1, 'required' => true]) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('max_payslips', $tier->max_payslips, ['class' => 'form-control', 'min' => 1, 'placeholder' => __('Leave empty for unlimited')]) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {{ Form::number('price_per_payslip', $tier->price_per_payslip, ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'placeholder' => __('e.g., 10.00'), 'required' => true]) }}
                </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <span class="text-danger">*</span>
                {{ Form::number('sort_order', $tier->sort_order ?? 0, ['class' => 'form-control', 'min' => 0, 'required' => true]) }}
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-rc-primary">{{ __('Update Tier') }}</button>
</div>
{{ Form::close() }}
