...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('annual-bonuses.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('bonus_amount') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="bonus_amount" value="{{ old('bonus_amount') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("annual-bonuses.ajax-validate-store") }}',
                data: formData,
