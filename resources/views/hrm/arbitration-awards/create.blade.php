...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('arbitration-awards.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('directive_number') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="directive_number" value="{{ old('directive_number') }}"
                                       placeholder="{{ __('Enter Directive No.') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('directive_issue_date') is-invalid @enderror"
                                       type="date" name="directive_issue_date" value="{{ old('directive_issue_date') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('directive_income_amount') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="directive_income_amount" value="{{ old('directive_income_amount') }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('tax_to_deduct') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="tax_to_deduct" value="{{ old('tax_to_deduct') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("arbitration-awards.ajax-validate-store") }}',
                data: formData,
