                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        <div class="section-title">
                            <h2>{{moduleAliasName($module->getName())}}</h2>
                        </div>
                        ...
                        <div class="price">
                            <ins><span class="currency-type">{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['monthly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                            <ins><span class="currency-type">{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['yearly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                        </div>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl">{{__('Billed monthly, or')}} <b>{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['monthly_price']).'/' }}</b>{{__(' if paid monthly')}}</div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl">{{__('Billed yearly, or')}} <b>{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['yearly_price']).'/' }}</b>{{__(' if paid yearly')}}</div>
                                        <div class="btn-group">
                                            <a href="{{ route('apps.pricing') }}" class="btn-secondary">{{__('Buy Now')}} <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image2.png'}}" target="_blank" class="img-zoom">
                            <img src="{{$path.'/image2.png'}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image3.png'}}" target="_blank" class="img-zoom">
                            <img src="{{$path.'/image3.png'}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image4.png'}}" target="_blank" class="img-zoom">
                            <img src="{{$path.'/image4.png'}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image5.png'}}" target="_blank" class="img-zoom">
                            <img src="{{$path.'/image5.png'}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image6.png'}}" target="_blank" class="img-zoom">
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{$path.'/image1.png'}}" target="_blank" class="img-zoom">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <h4> <a href="product.html">{{ moduleAliasName($module->getName()) }}</a> </h4>
                                    <div class="price">
                                        <ins><span class="currency-type">{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['monthly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Month') }}</span></ins>
                                                    <ins><span class="currency-type">{{ superCurrencyFormatWithSym(modulePriceByName($module->getName())['yearly_price']) }}</span> <span class="time-lbl text-muted">{{ __('/Year') }}</span></ins>
                                    </div>
                                    <a href="{{ route('software.details',moduleAliasName($module->getName())) }}" target="_new"  class="btn cart-btn">View Details</a>
                                </div>
                            </div>
                        </div>
                        @endif
