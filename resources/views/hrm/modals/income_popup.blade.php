                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="list-group">
                            ...
                            <a href="{{ route('payslipcommission.index') }}" class="list-group-item list-group-item-action">Commission</a>
                            <a href="{{ route('company-car-taxable-types.index') }}" class="list-group-item list-group-item-action">Company Car</a>
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item list-group-item-action">
                                <a href="/employer-loan" class="text-decoration-none d-block">Employer Loan</a>
                            </li>
                            <li class="list-group-item list-group-item-action" onclick="window.location.href='/employer-loan'">Employer Loan</li>
                            <li class="list-group-item list-group-item-action" onclick="window.location.href='{{ route('employer-loan.index') }}'">Employer Loan</li>
