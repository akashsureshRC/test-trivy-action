        ...
        <div class="">
                        ...
                        <div class="col-sm-12 card py-4 px-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-icon-user">
                                    {{ Form::select('name_option', 
            ['Option 1' => 'Option 1', 'Option 2' => 'Option 2', 'Other' => 'Other'], 
            null, 
            ['class' => 'form-control', 'id' => 'nameDropdown', 'required' => 'required', 'placeholder' => 'Select Employee']) 
                                ...
                                <div class="form-group mt-3 d-none" id="dynamicInputContainer">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::text('dynamic_input', null, ['class' => 'form-control', 'id' => 'dynamicInput', 'placeholder' => 'Enter your CTC']) }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="salaryTable">
                                <tr>
                                    <th colspan="5">Regular Inputs</th>
                                </tr>
                                <tr>
                                    <th>Income</th>
                                    <th>Allowance</th>
                                ...
                                <tr>
                                    <td>Basic</td>
                                    <td><input type="text" value="50.00"> % of CTC</td>
                                    <td><input type="text" value="41667"></td>
                                    <td><input type="text" value="500004"></td>
                                    <td></td>
                                </tr>
                                <tr id="deductionsHeader">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" value="1000000"></td>
                                    <td></td>
                                </tr>
                            </table>
                        ...
                        <div class="row">
                            <div class="col-sm-12 card py-4 px-4">
                                <h5 style="text-transform: uppercase;">{{ __('Personal Details') }}</h5>
                                <hr>
                                <div class="row">
                                    <div class="form-group col-md-6">
                        ...
                        <div class="row " style="margin-bottom: 55px; margin-top: 20px;">
                            <div class="col"></div>
                            <div class="col-6 text-end">
                                <button class="btn btn-rc-primary d-inline-flex align-items-center" id="nextButton"
                    ...
                    <div class="tab-pane fade" id="company-tab" role="tabpanel" aria-labelledby="pills-user-tab-2">
                        <div class="row">
                            <div class="col-sm-12 card py-4 px-4">
                                <h5 style="text-transform:uppercase">{{ __('Company Detail') }}</h5>
                                <hr>
                                <div class="row">
                                    ...
                                    @if (moduleIsActive('CustomField') && !$customFields->isEmpty())
                                    <div class="col-md-12">
                            ...
                            <div class="col-sm-12 card px-4 py-4">
                                <h5 style="text-transform:uppercase">{{ __('Hours and Rates Detail') }}</h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>{{ __('Hours') }}</h6>
                        ...
                        <div class="mt-3 row" style="margin-top: 20px; margin-bottom: 55px;">
                            <div class="col-6">
                            ...
                            <div class="col-6 text-end" id="savebutton">
                                <a class="btn"
                                    href="{{ route('employees.list') }}">{{ __('Cancel') }}</a>
                                <button class="btn btn-rc-primary" type="submit"
...
<script>
    document.getElementById('nameDropdown').addEventListener('change', function() {
        ...
        const inputLabel = document.getElementById('dynamicLabel');

        if (this.value) {
            inputContainer.classList.remove('d-none');
            inputLabel.textContent = `Annual CTC`;
            inputField.placeholder = `100000 `;
...
<script>
    function addRow() {
        ...
        const deductionsHeader = document.getElementById("deductionsHeader");
        const row = table.insertRow(deductionsHeader.rowIndex);
        row.innerHTML = `
                <td>House Rent Allowance</td>
                <td><input type="text" value="50.00" >% of Basic</td>
                <td><input type="text" value="20834" ></td>
                <td><input type="text" value="250008" ></td>
