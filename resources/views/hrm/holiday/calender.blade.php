...
@section('page-action')
    <div>
        <a href="{{ route('holiday.index') }}" class="btn btn-sm btn-rc-primary" data-bs-toggle="tooltip"
            data-bs-original-title="{{ __('List View') }}">
            <i class="ti ti-list-check"></i>
        </a>
        @permission('holiday create')
            <a  class="btn btn-sm btn-rc-primary" data-ajax-popup="true" data-size="md"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <a  class="btn btn-sm btn-rc-primary"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div class="card-text small text-dark">{{ __('Start Date :') }}
                                                    {{ companyDateFormate($event->start_date) }}
                                                </div>
                                                <div class="card-text small text-dark">{{ __('End Date :') }}
                                                    {{ companyDateFormate($event->end_date) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
