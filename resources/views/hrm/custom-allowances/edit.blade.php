...
@section('page-title')
    {{ __('Edit Custom Allowance') }}
@endsection
@section('page-breadcrumb')
    {{ __('Employee') }} > {{ __('Edit Custom Allowance') }}
@endsection
@php
...
@section('content')
    ...
    <div class="container mt-5">
        <div class="white-section">
            ...
            <form action="{{ route('custom-allowances.update',$customAllowance->id) }}" class="mt-3" method="POST">
                @csrf
                @method('put')
                <div class="row mb-3">
                    <label class="col-sm-2 form-label">Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control @error('name')" is-invalid @enderror value="{{ old('name',$customAllowance->name) }}">
                        @error('name')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select id="input_type" name="input_type" class="form-control @error('input_type') is-invalid @enderror">
                            ...
                            <option value="fixed_amount" {{ $customAllowance->input_type == 'fixed_amount' ? 'selected' : '' }}>Fixed Amount</option>
                            <option value="hourly_rate_factor_hours" {{ $customAllowance->input_type == 'hourly_rate_factor_hours' ? 'selected' : '' }}>Hourly rate * factor * hours</option>
                            <option value="custom_rate_quantity" {{ $customAllowance->input_type == 'custom_rate_quantity' ? 'selected' : '' }}>Custom rate * quantity</option>
                            <option value="monthly" {{ $customAllowance->input_type == 'monthly' ? 'selected' : '' }}>Monthly (for non-monthly employees)</option>
                        </select>
                        @error('input_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div id="fixed_amount_section" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="amount" name="amount" class="form-control" value="{{ old('amount', $customAllowance->amount) }}">
                    </div>
                </div>
                ...
                <div id="hourly_rate_section" style="display: none;">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="rate_factor" name="rate_factor" class="form-control" value="{{ old('rate_factor', $customAllowance->rate_factor) }}">
                    </div>
                    <div class="mb-3">
                        <label for="employee_work_factor" class="form-label">Hours Worked Factor</label>
                        <input type="number" step="0.01" id="employee_work_factor" name="employee_work_factor" class="form-control" value="{{ old('employee_work_factor', $customAllowance->employee_work_factor) }}">
                    </div>
                </div>
                ...
                <div id="custom_rate_section" style="display: none;">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="hours_work_factor" name="hours_work_factor" class="form-control" value="{{ old('hours_work_factor', $customAllowance->hours_work_factor) }}">
                    </div>
                    <div id="custom_rate_input_section">
                        <div class="mb-3">
                            <label for="custom_rate" class="form-label">Custom Rate</label>
                            <input type="number" step="0.01" id="custom_rate" name="custom_rate" class="form-control" value="{{ old('custom_rate', $customAllowance->custom_rate) }}">
                        </div>
                    </div>
                    <div class="mb-3 form-check">
                ...
                <div id="monthly_section" style="display: none;">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="monthly_amount" name="monthly_amount" class="form-control" value="{{ old('monthly_amount', $customAllowance->monthly_amount) }}">
                    </div>
                </div>
