...
<body>
    ...
    <div class="container mt-5">
        <div class="white-section"> <!-- White background section -->
            ...
            <form id="editForm" action="{{ route('add-maintenance.update',$addmaintenanceOrder->id) }}" class="mt-3" method="post">
                @csrf
                @method('put')
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ old('employee_name', $addmaintenanceOrder->employee_name) }}">
                    @error('employee_name')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="bank" class="form-control @error('bank') is-invalid @enderror">
                            ...
                            <option value="ABSA Bank" {{ old('bank',$addmaintenanceOrder->bank) == 'ABSA Bank' ? 'selected' : '' }}> ABSA Bank</option>
                            <option value="Capitec Bank" {{ old('bank',$addmaintenanceOrder->bank) == 'Capitec Bank' ? 'selected' : '' }}> Capitec Bank</option>
                            <option value="First National Bank" {{ old('bank',$addmaintenanceOrder->bank) == 'First National Bank' ? 'selected' : '' }}> First National Bank
                            </option>
                    ...
                    <div class="col-sm-10">
                       <!-- <label class="form-label require">{{ __('Hourly Rate') }}</label>-->
                        <input type="number" name="account_number"
                            ...
                            value="{{ old('account_number',$addmaintenanceOrder->account_number) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ old('branch_code',$addmaintenanceOrder->branch_code) }}">
                    @error('branch_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="account_type" class="form-control @error('account_type') is-invalid @enderror">
                            ...
                            <option value="Current (cheque)" {{ old('account_type',$addmaintenanceOrder->account_type) == 'Current (cheque)' ? 'selected' : '' }}> Current (cheque)</option>
                            <option value="Savings" {{ old('account_type',$addmaintenanceOrder->account_type) == 'Savings' ? 'selected' : '' }}> Savings</option>
                            <option value="Transmission" {{ old('account_type',$addmaintenanceOrder->account_type) == 'Transmission' ? 'selected' : '' }}> Transmission
                            </option>
                ...
                <div class="row mb-3" id="eft_payment_type_div" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        <select id="eft_payment_type" name="eft_payment_type" class="form-control">
                            ...
                            <option value="each_employee" {{ old('eft_payment_type',$addmaintenanceOrder->eft_payment_type) == 'Savings' ? 'selected' : '' }}>Payment for Each Employee</option>
                            <option value="lump_sum" {{ old('eft_payment_type',$addmaintenanceOrder->eft_payment_type) == 'Savings' ? 'selected' : '' }}>Single Lump Sum Payment</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3" id="your_reference_div" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ old('your_reference',$addmaintenanceOrder->your_reference) }}">
                ...
                <div class="row mb-3" id="beneficiary_reference_div" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ old('beneficiary_reference',$addmaintenanceOrder->beneficiary_reference) }}">
...
<script>
    $(document).ready(function() {
        $('#editForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("add-maintenance.ajax-validate-update", $addmaintenanceOrder->id) }}',
                data: formData,
