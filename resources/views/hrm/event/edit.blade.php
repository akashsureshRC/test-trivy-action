        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class=" btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                    <label
                        class="btn bg-info p-3 {{ $event->color == 'event-info' ? 'custom_color_radio_button event_color_active '
                            : '' }} "><input
                            ...
                            <div class="">
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8"><span
                                                class="text-sm">{{ companyDateFormate($event->start_date) }}</span>
                                        </dd>
                                        <dt class="col-sm-4"><span
                                                class="h6 text-sm mb-0">{{ __('End Date') }}</span>
                                        </dt>
                                        <dd class="col-sm-8"><span
                                                class="text-sm">{{ companyDateFormate($event->end_date) }}</span>
                                        </dd>
                                        <dt class="col-sm-4"><span
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class=" btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                            <label
                                class="btn bg-info p-3 {{ $event->color == 'event-info' ? 'custom_color_radio_button '
                                    : '' }} "><input
                                    type="radio" name="color" class="d-none event_color" value="event-info"
                                    {{ $event->color == 'event-info' ? 'checked' : '' }}></label>
