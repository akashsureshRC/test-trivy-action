...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('dividends-subject.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="directive_income_source_code" class="form-control @error('directive_income_source_code') is-invalid @enderror"
                                       value="{{ old('directive_income_source_code') }}" placeholder="{{ __('Enter Source Code') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" name="tax_to_deduct" class="form-control @error('tax_to_deduct') is-invalid @enderror"
                                       value="{{ old('tax_to_deduct', 0) }}">
                                @error('tax_to_deduct')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("dividends-subject.ajax-validate-store") }}',
                data: formData,
