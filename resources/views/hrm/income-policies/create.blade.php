...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('income-policies.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="require form-label">{{ __('Fixed Amount') }}</label>
                                <input class="form-control @error('payout_amount') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="payout_amount" value="{{ old('payout_amount') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("income-policies.ajax-validate-store") }}',
                data: formData,
