...
<div class="col-sm-12 col-lg-12 col-xl-12 col-md-12">
    ...
    <div class="col-xl-12">
        <x-rc-table title="{{ __('Leave Report') }}" titleIcon="ti ti-calendar-minus">
            <x-rc-table.content>
                                        ...
                                        <td>
                                            @permission('employee show')
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('employees.show', $leave['id']) }}">{{ App\Services\PayrollHelperService::employeeIdFormat($leave['employee_id']) }}</a>
                                            @else
                                                <a  class="btn btn-outline-primary">{{ App\Services\PayrollHelperService::employeeIdFormat($leave['employee_id']) }}</a>
                                            @endpermission
                                        </td>
                                    @else
                                        <td>--</td>
