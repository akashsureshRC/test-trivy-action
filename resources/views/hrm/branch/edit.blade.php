...
{{ Form::model($branch, ['route' => ['branch.update', $branch->id], 'method' => 'PUT', 'id' => 'branchForm']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="d-flex align-items-center">
                    ...
                    {{ Form::number('attendance_radius', null, ['class' => 'form-control', 'id' => 'attendance_radius', 'placeholder' => __('100'), 'min' => '10', 'max' => '10000', 'style' => 'width: 100px;']) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('clock_in_tolerance_minutes', null, ['class' => 'form-control', 'min' => '0', 'max' => '60']) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('clock_out_tolerance_minutes', null, ['class' => 'form-control', 'min' => '0', 'max' => '60']) }}
