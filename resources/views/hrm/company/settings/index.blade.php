@permission('hrm manage')
    <div class="card" id="hrm-sidenav">
        ...
        <div class="card-footer text-end">
            <input class="btn btn-print-invoice btn-rc-primary m-r-10 hrm_setting_btn" type="button"
                            ...
                            <li class="dropdown dash-h-item drp-language" style="margin-top: -19px;">
                                ...
                                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                                    ...
                                    @foreach (languages() as $key => $offerlangs)
                                        <a href="{{ route('settings.index', ['noclangs' => $noclang, 'explangs' => $explang, 'offerlangs' => $key]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card-header card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">{{ __('Job Image') }}</label>
                        ...
                        <li class="dropdown dash-h-item drp-language" style="margin-top: -19px;">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                                ...
                                @foreach (languages() as $key => $explangs)
                                    <a href="{{ route('settings.index', ['noclangs' => $noclang, 'explangs' => $key, 'offerlangs' => $offerlang]) }}"
                        ...
                        <li class="dropdown dash-h-item drp-language" style="margin-top: -19px;">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                                ...
                                @foreach (languages() as $key => $noclangs)
                                    <a href="{{ route('settings.index', ['noclangs' => $key, 'explangs' => $explang, 'offerlangs' => $offerlang]) }}"
