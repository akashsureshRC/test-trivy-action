    ...
    <div class="row px-3">
        <div class="col-md-4 mb-3">
            ...
            <h5 class="emp-title black-text">
                {{ !empty(App\Services\PayrollHelperService::GetEmployeeByEmp($payslip->employee_id)) ? App\Services\PayrollHelperService::employeeIdFormat($payslip->employee_id) : '' }}
            </h5>
        </div>
        <div class="col-md-4 mb-3">
            <h5 class="emp-title mb-0">{{ __('Basic Salary') }}</h5>
            <h5 class="emp-title black-text">{{ currencyFormat($payslip->basic_salary) }}</h5>
        </div>
        <div class="col-md-4 mb-3">
            <h5 class="emp-title mb-0">{{ __('Payroll Month') }}</h5>
            <h5 class="emp-title black-text">{{ companyDateFormate($payslip->salary_month) }}</h5>
        </div>
