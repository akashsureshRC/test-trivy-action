...
@section('content')
    <div class="main-content">
        <section class="section">
                        ...
                        <div class="col-md-6 ">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('branch_id',!empty($company_settings['hrm_branch_name']) ? $company_settings['hrm_branch_name'] : __('Branch') ) }}
                                        {{ Form::select('branch_id', $branches,null, array('class' => 'form-control choices','required'=>'required')) }}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('designation_id', !empty($company_settings['hrm_designation_name']) ? $company_settings['hrm_designation_name'] : __('Designation') ) }}
                                        <select class=" form-control select2-multiple" id="designation_id" name="designation_id" data-toggle="select2" data-placeholder="{{ __('Select Designation ...') }}">
                                            <option value="">{{__('Select '.(!empty($company_settings['hrm_designation_name']) ? $company_settings['hrm_designation_name'] : __('Designation')))}}</option>
            ...
            {!! Form::submit('save', ['class' => 'btn btn-rc-primary btn-lg float-right']) !!}
            {!! Form::close() !!}
        </section>
    </div>
        ...
        $(function getDesignation(did) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#designation_id').append('<option value="">('Select '.(!empty($company_settings['hrm_designation_name']) ? $company_settings['hrm_designation_name'] : __('Designation')))</option>');
