        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a>Home</a></div>
                                        ...
                                        <div class="company-setting-wrap">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('salary_type', $payslip_type, null, ['class' => 'form-control choices', 'required' => 'required']) }}
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12 text-right mt-1">
                                                    {{ Form::button('<i class="fas fa-plus"></i> ' . __('Save Change'), ['type' => 'submit','class' => 'btn btn-rc-primary']) }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('loan_option', $loan_options, null, ['class' => 'form-control choices', 'required' => 'required']) }}
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group">
