...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('covid19-disasters.store') }}" method="POST">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="affects_wage_eti">{{ __('Affects Wage for ETI Purposes') }}</label>
                        </div>
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("covid19-disasters.ajax-validate-store") }}',
                data: formData,
