...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('annual-payments.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="require form-label">{{ __('Annual Payment') }}</label>
                                <input class="form-control @error('annual_amount') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="annual_amount" value="{{ old('annual_amount') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("annual-payments.ajax-validate-store") }}',
                data: formData,
