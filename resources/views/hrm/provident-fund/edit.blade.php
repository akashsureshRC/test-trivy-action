...
@section('page-action')
    <div>
        <a href="{{ route('payroll.index', ['employee_id' => $provident_fund->employee_id, 'term' => $term]) }}" class="btn btn-rc-outline btn-sm">
...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="editForm" action="{{ route('provident-fund.update', $employee) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control @error('contribution') is-invalid @enderror" name="contribution" id="contribution">
                            ...
                            <option value="fixed_amount" {{ old('contribution', $provident_fund->contribution) == 'fixed_amount' ? 'selected' : '' }}>Fixed Amount</option>
                            <option value="percentage_rfi" {{ old('contribution', $provident_fund->contribution) == 'percentage_rfi' ? 'selected' : '' }}>% of Retirement Funding Income</option>
                        </select>
                        @error('contribution')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror 
                    ...
                    <!-- Fixed Amount Inputs -->
                    <div id="fixed_contribution_section" style="{{ $provident_fund->contribution == 'fixed_amount' ? 'display:block;' : 'display:none;' }}">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('fixed_contribution_employee') is-invalid @enderror"
                                ...
                                value="{{ old('fixed_contribution_employee', $provident_fund->fixed_contribution_employee) }}"
                                placeholder="{{ __('Enter Employee Amount') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('fixed_contribution_employer') is-invalid @enderror"
                                ...
                                value="{{ old('fixed_contribution_employer', $provident_fund->fixed_contribution_employer) }}"
                                placeholder="{{ __('Enter Employer Amount') }}">
                    ...
                    <div id="percentage_rfi_section" style="{{ $provident_fund->contribution == 'percentage_rfi' ? 'display:block;' : 'display:none;' }}">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('percentage_rfi_employee') is-invalid @enderror"
                                ...
                                name="percentage_rfi_employee" value="{{ old('percentage_rfi_employee', $provident_fund->percentage_rfi_employee) }}"
                                placeholder="{{ __('Enter Employee Percentage') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('percentage_rfi_employer') is-invalid @enderror"
                                type="number" step="0.01" min="0" max="100"
                                name="percentage_rfi_employer" value="{{ old('percentage_rfi_employer', $provident_fund->percentage_rfi_employer) }}"
                                placeholder="{{ __('Enter Employer Percentage') }}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('category') is-invalid @enderror" 
                                   type="number" step="0.01" min="0" name="category" value="{{ old('category', $provident_fund->category) }}" 
...
<input type="hidden" name="term" value="{{ request('term') }}">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a class="btn btn-rc-outline" href="{{ route('payroll.index', ['employee_id' => $provident_fund->employee_id]) }}">
                            {{ __('Cancel') }}
                        </a>
...
<script>
    $(document).ready(function() {
        $('#editForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("provident-fund.ajax-validate-update", $provident_fund->id) }}',
                data: formData,
