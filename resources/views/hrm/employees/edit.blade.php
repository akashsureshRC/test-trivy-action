        ...
        <form id="employeeForm" action="{{ route('employees.update', $employee->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="employee_id" class="form-label">{{ __('Employee ID') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="salutation" name="salutation" class="form-control">
                                    ...
                                    <option value="Miss" {{ old('salutation', $employee->salutation) == 'Miss' ? 'selected' : '' }}>Miss</option>
                                </select>
                                @error('salutation')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="department_id" name="department_id" class="form-control">
                                    ...
                                    @php
                                        $activeBranchId = old('branch_id', $employee->branch_id);
                                        $branchDepartments = $activeBranchId
                                            ? App\Models\Hrm\Department::where('branch_id', $activeBranchId)
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="designation" name="designation_id" class="form-control"
                                    ...
                                    @php
                                        $activeDeptId = old('department_id', $employee->department_id);
                                        $deptDesignations = $activeDeptId
                                            ? App\Models\Hrm\Designation::where('department_id', $activeDeptId)->get()
                                            : collect();
                                    @endphp
                                    @foreach ($deptDesignations as $designation)
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="date_of_appointment" name="date_of_appointment"
                                    class="form-control"
                                    value="{{ old('date_of_appointment', $employee->date_of_appointment ?? '') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="identification_type" name="identification_type" class="form-control">
                                    ...
                                    <option value="RSA ID" {{ old('identification_type', $employee->identification_type) == 'RSA ID' ? 'selected' : '' }}>RSA ID</option>
                                    <option value="Passport/foreign id" {{ old('identification_type', $employee->identification_type) == 'Passport/foreign id' ? 'selected' : '' }}>Passport</option>
                                    <option value="Refugee id" {{ old('identification_type', $employee->identification_type) == 'Refugee id' ? 'selected' : '' }}>Refugee Id</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="id_number" name="id_number" class="form-control"
                                    value="{{ old('id_number', $employee->id_number) }}" placeholder="{{ __('Enter ID Number') }}">
                                @error('id_number')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="tax_reference_number" name="tax_reference_number" class="form-control"
                                    value="{{ old('tax_reference_number', $employee->tax_reference_number ?? '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="passport_country" name="passport_country" class="form-control">
                                    ...
                                    <option value="{{ $cou->name }}"
                                        {{ old('passport_country', $employee->passport_country ?? '') == $cou->name ? 'selected' : '' }}>
                                        {{ $cou->name }}
                                    </option>
                                    @endforeach
                                </select>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="attendance_enabled"
                                        ...
                                        {{ old('attendance_enabled', $employee->attendance_enabled) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="margin: 0px">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="use_custom_working_hours" id="use_custom_working_hours" value="1" {{ old('use_custom_working_hours', $employee->use_custom_working_hours) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12" id="configureWorkingHoursDiv"
                            style="{{ old('use_custom_working_hours', $employee->use_custom_working_hours) ? '' : 'display:none;' }}">
                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-outline-primary"
                                data-ajax-popup="true" data-size="xl"
                                data-url="{{ route('employee.working-hours', $employee->id) }}"
                                data-title="{{ __('Custom Working Hours - ') . $employee->first_name . ' ' . $employee->last_name }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="bank" id="bank" class="form-control">
                                    ...
                                    <option value="ABSA Bank" {{ old('bank', $employee->bank) == 'ABSA Bank' ? 'selected' : '' }}>ABSA Bank</option>
                                    <option value="African Bank" {{ old('bank', $employee->bank) == 'African Bank' ? 'selected' : '' }}>African Bank</option>
                                    <option value="Bidvest Bank" {{ old('bank', $employee->bank) == 'Bidvest Bank' ? 'selected' : '' }}>Bidvest Bank</option>
                                    <option value="Bank Zero" {{ old('bank', $employee->bank) == 'Bank Zero' ? 'selected' : '' }}>Bank Zero</option>
                                    <option value="Capitec Bank" {{ old('bank', $employee->bank) == 'Capitec Bank' ? 'selected' : '' }}>Capitec Bank</option>
                                    <option value="Capitec Business Bank" {{ old('bank', $employee->bank) == 'Capitec Business Bank' ? 'selected' : '' }}>Capitec Business Bank</option>
                                    <option value="Discovery Bank" {{ old('bank', $employee->bank) == 'Discovery Bank' ? 'selected' : '' }}>Discovery Bank</option>
                                    <option value="FNB" {{ old('bank', $employee->bank) == 'FNB' ? 'selected' : '' }}>FNB</option>
                                    <option value="Investec" {{ old('bank', $employee->bank) == 'Investec' ? 'selected' : '' }}>Investec</option>
                                    <option value="Mukuru bank" {{ old('bank', $employee->bank) == 'Mukuru bank' ? 'selected' : '' }}>Mukuru bank</option>
                                    <option value="Nedbank" {{ old('bank', $employee->bank) == 'Nedbank' ? 'selected' : '' }}>Nedbank</option>
                                    <option value="Postbank" {{ old('bank', $employee->bank) == 'Postbank' ? 'selected' : '' }}>Postbank</option>
                                    <option value="Standard Bank" {{ old('bank', $employee->bank) == 'Standard Bank' ? 'selected' : '' }}>Standard Bank</option>
                                    <option value="Sasfin Bank" {{ old('bank', $employee->bank) == 'Sasfin Bank' ? 'selected' : '' }}>Sasfin Bank</option>
                                    <option value="TymeBank" {{ old('bank', $employee->bank) == 'TymeBank' ? 'selected' : '' }}>TymeBank</option>
                                    <option value="Albaraka Bank" {{ old('bank', $employee->bank) == 'Albaraka Bank' ? 'selected' : '' }}>Albaraka Bank</option>
                                    <option value="HBZ Bank" {{ old('bank', $employee->bank) == 'HBZ Bank' ? 'selected' : '' }}>HBZ Bank</option>
                                </select>
                                @error('bank')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="account_type" id="account_type" class="form-control">
                                    ...
                                    <option value="savings" {{ old('account_type', $employee->account_type) == 'savings' ? 'selected' : '' }}>Savings</option>
                                    <option value="current" {{ old('account_type', $employee->account_type) == 'current' ? 'selected' : '' }}>Current</option>
                                    <option value="Bond" {{ old('account_type', $employee->account_type) == 'Bond' ? 'selected' : '' }}>Bond</option>
                                    <option value="Transmission" {{ old('account_type', $employee->account_type) == 'Transmission' ? 'selected' : '' }}>Transmission</option>
                                </select>
                                @error('account_type')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="holder_relationship" id="holder_relationship" class="form-control">
                                    ...
                                    <option value="Own" {{ old('holder_relationship', $employee->holder_relationship) == 'Own' ? 'selected' : '' }}>Own</option>
                                    <option value="Joined" {{ old('holder_relationship', $employee->holder_relationship) == 'Joined' ? 'selected' : '' }}>Joined</option>
                                    <option value="Third Party" {{ old('holder_relationship', $employee->holder_relationship) == 'Third Party' ? 'selected' : '' }}>Third Party</option>
                                </select>
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-end gap-2">
                    <a href="{{ route('employees.list') }}" class="btn btn-rc-outline">{{ __('Cancel') }}</a>
                    <button type="submit" id="updateEmployeeBtn" class="btn btn-rc-primary">{{ __('Update Employee') }}</button>
                </div>
            </div>
        </form>
                    ...
                    <form id="designationForm">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="designation_department" class="form-label">{{ __('Department') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="modal_desg_branch_id" class="form-label">{{ __('Branch') }} <span class="text-danger">*</span></label>
                                        <select id="modal_desg_branch_id" name="branch_id" class="form-control">
                                            <option value="">{{ __('Select Branch') }}</option>
                                            @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                                            @endforeach
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script>
        function getProvinces(country) {
            ...
            fetch(`/get-provinces/${encodeURIComponent(country)}`)
                .then(response => response.json())
                .then(data => {
    ...
    <script>
        $(document).ready(function() {
            $('#employeeForm').on('submit', function(e) {
                ...
                $('#updateEmployeeBtn').prop('disabled', true).html('Updating...');
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        $('#updateEmployeeBtn').prop('disabled', false).html('Update Employee');
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            let departmentModalBranchSelect = document.querySelector('#addDepartmentModal #modal_branch_id');
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#use_custom_working_hours').on('change', function() {
                if ($(this).is(':checked')) {
                    $('#configureWorkingHoursDiv').slideDown();
                } else {
                    $('#configureWorkingHoursDiv').slideUp();
                }
            });
        });
    </script>
