...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('tax-over-deduction.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="require form-label">{{ __('Per Period') }}</label>
                                <input class="form-control @error('per_period') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="per_period" value="{{ old('per_period') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("tax-over-deduction.ajax-validate-store") }}',
                data: formData,
