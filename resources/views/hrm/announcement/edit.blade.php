    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('branch_id', $branch, null, ['class' => 'form-control choices', 'required' => 'required', 'placeholder' => __('Select '.(!empty($company_settings['hrm_branch_name']) ? $company_settings['hrm_branch_name'] : __('select Branch')))]) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('end_date', __('Announcement start Date'), ['class' => 'form-label']) }}
...
<div class="modal-footer">
    ...
    {{ Form::submit(__('Save Changes'), ['class' => 'btn btn-rc-primary','id'=>'submit']) }}
</div>
{{ Form::close() }}
<script>
