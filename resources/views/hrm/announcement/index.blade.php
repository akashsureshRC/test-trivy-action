...
<div>
    @permission('announcement create')
        <a  class="btn btn-sm btn-rc-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Announcement') }}" data-url="{{route('announcement.create')}}" data-toggle="tooltip" title="{{ __('Create') }}">
...
<div class="row">
    <div class="col-sm-12">
        <x-rc-table title="{{ __('Announcements') }}" titleIcon="ti ti-speakerphone">
            <x-rc-table.content>
                <table class="rc-table" id="assets">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-date">{{ companyDateFormate($announcement->start_date) }}</td>
                            <td class="col-date">{{ companyDateFormate($announcement->end_date) }}</td>
                            <td>
                            ...
                            @if (Laratrust::hasPermission('announcement edit') || Laratrust::hasPermission('announcement delete'))
                                <td class="col-actions">
                                    <span>
                                        ...
                                        <div class="rc-table-action rc-table-action-edit ms-2">
                                        ...
                                        <div class="rc-table-action rc-table-action-delete ms-2">
                        ...
                        @empty
                        <x-rc-table.empty :asRow="true" :colspan="5" icon="ti ti-speakerphone" title="{{ __('No Announcements') }}" message="{{ __('No announcements have been created yet.') }}" />
                        @endforelse
                    </tbody>
                </table>
            </x-rc-table.content>
