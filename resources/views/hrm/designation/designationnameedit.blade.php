    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                {{ Form::label('hrm_designation_name', (!empty($company_settings['hrm_designation_name']) ? $company_settings['hrm_designation_name'] : __('Designation')) . ' Name', ['class' => 'form-label']) }}
