...
@section('content')
<form id="createForm" action="{{ route('company-basic-salaries.store') }}" class="mt-3" method="post">
    @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-xxl:8 col-xl:8 col-md-8 ">
                                ...
                                <select name="employee_minimum_pay" class="form-control @error('employee_minimum_pay') is-invalid @enderror">
                                    ...
                                    <option value="  Normal Day's Wage">  Normal Day's Wage</option>
                                    <option value=" Double normal Day's Wage"> Double normal Day's Wage
                                    </option>
                        ...
                        <div class="row" id="RatesRow" style="display: none; margin-top: 10px;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xxl:8 col-xl:8 col-md-8 ">
                                    ...
                                    value="{{ old('holiday_normal_multiplier') }}">
                            ...
                            <div class="row align-items-center py-4">
                                ...
                                <div class="col-xxl:8 col-xl:8 col-md-8 ">
                                    ...
                                    value="{{ old('holiday_overtime_multiplier') }}">
                        ...
                        <div class="row" id="SundayRow" style="display: none; margin-top: 10px;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xxl:8 col-xl:8 col-md-8 ">
                                    ...
                                    value="{{ old('normally_works_multiplier') }}">
                            ...
                            <div class="row align-items-center py-4">
                                ...
                                <div class="col-xxl:8 col-xl:8 col-md-8 ">
                                    ...
                                    value="{{ old('normally_off_multiplier') }}">
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("company-basic-salaries.ajax-validate-store") }}',
                data: formData,
