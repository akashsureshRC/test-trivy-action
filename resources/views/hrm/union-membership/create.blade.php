...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <form id="createForm" action="{{ route('union-membership.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('amount_per_period') is-invalid @enderror"
                                       type="number" step="0.01" min="0" name="amount_per_period" value="{{ old('amount_per_period') }}"
...
<script>
    $(document).ready(function() {
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("union-membership.ajax-validate-store") }}',
                data: formData,
