...
@section('page-action')
    <div>
        <a href="{{ route('notification-template.index') }}" class="btn btn-sm btn-rc-primary" data-bs-toggle="tooltip"
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-end mb-3">
                            ...
                            <button type="submit" class="btn btn-print-invoice btn-rc-primary m-r-10">{{ __('Save') }}</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
