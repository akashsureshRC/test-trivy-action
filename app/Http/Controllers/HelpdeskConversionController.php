        ...
        if ($ticket) {
            ...
            if ($request->hasfile('reply_attachments')) {
                foreach ($request->file('reply_attachments') as $file) {
                    ...
                    multiUploadFile($file, 'reply_attachments', $name, 'helpdesk/' . $ticket->ticket_id);
                }
            }
            ...
            $error_msg = EmailTemplate::sendEmailTemplate('New Helpdesk Ticket Reply', [$ticket->email], $uArr, creatorId(), getActiveWorkspace());
