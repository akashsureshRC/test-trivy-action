...
class RepaymentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hrm.repayments.create',compact('employee','term'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('payroll.index', ['employee_id' => $request->employee_id,'term' => $term])
                    ->with('success', 'Repayment of Loan deduction added successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        $repayment =  Repayments::findOrFail($id);
         $term = $request->query('term', $repayment->term); 
        return view('hrm.repayments.edit', compact('repayment','term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('payroll.index', ['employee_id' => $repayment->employee_id,'term' => $repayment->term])
                    ->with('success', 'Repayment of Loan deduction updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('payroll.index', ['employee_id' => $employee_id,'term' => $term])->with('success', 'Repayments deleted successfully.');
    }
