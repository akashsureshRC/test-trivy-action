...
class RestraintOfTradeController extends Controller
{
    /**
    ...
    public function create(Request $request)
    {
        ...
        return view('hrm.restraint-of-trade.create',compact('employee','term'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('payroll.index', ['employee_id' => $request->employee_id,'term' => $term])
                    ->with('success', 'Restraint of Trade added successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        $restraint = RestraintOfTrade::findOrFail($id);
         $term = $request->query('term', $restraint->term);
        return view('hrm.restraint-of-trade.edit', compact('restraint','term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $restraint->update($request->all());

        return redirect()->route('payroll.index', ['employee_id' => $restraint->employee_id,'term' => $restraint->term])
                    ->with('success', 'Restraint of Trade updated successfully.');
    }
    ...
    {
        $restraint = RestraintOfTrade::findOrFail($id);
        $employee_id = $restraint->employee_id;
        $term = $restraint->term;
        $restraint->delete();

        return redirect()->route('payroll.index', ['employee_id' => $employee_id,'term' => $term])->with('success', 'Restraint of Trade deleted successfully.');
    }
