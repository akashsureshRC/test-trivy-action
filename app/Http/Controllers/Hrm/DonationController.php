...
class DonationController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hrm.donations.create',compact('employee','term'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('payroll.index', ['employee_id' => $request->employee_id,'term' => $term])
                    ->with('success', 'Donation Deduction added successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit(Request $request, $id)
    {
        $donation = Donation::findOrFail($id);
         $term = $request->query('term', $donation->term); 
        return view('hrm.donations.edit', compact('donation','term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('payroll.index', ['employee_id' => $donation->employee_id,'term' => $donation->term])
