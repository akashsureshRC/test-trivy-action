...
class ExpenseClaimController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('hrm.expense-claims.create',compact('employee','term'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('payroll.index', ['employee_id' => $request->employee_id,'term' => $term])
                    ->with('success', 'Expense Claim added successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        $expenseClaim = ExpenseClaim::findOrFail($id);
        $term = $request->query('term', $expenseClaim->term);
        return view('hrm.expense-claims.edit', compact('expenseClaim','term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('payroll.index', ['employee_id' => $expenseClaim->employee_id,'term' => $expenseClaim->term])
    ...
    {
        $expenseClaim = ExpenseClaim::findOrFail($id);
        $employee_id = $expenseClaim->employee_id;
        $term = $expenseClaim->term;
        $expenseClaim->delete();

        return redirect()->route('payroll.index', ['employee_id' => $employee_id,'term' => $term])->with('success', 'Expense Claim Allowance deleted successfully.');
    }
